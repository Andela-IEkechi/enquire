...
#       expect(assigns(:user_profiles)).to eq([user_profile])
#     end
#   end
#
...
#         post :create, {:user_profile => invalid_attributes}, valid_session
#         expect(assigns(:user_profile)).to be_a_new(UserProfile)
#       end
#
...
#         user_profile = UserProfile.create! valid_attributes
#         put :update, {:id => user_profile.to_param, :user_profile => new_attributes}, valid_session
#         user_profile.reload
...
#         user_profile = UserProfile.create! valid_attributes
#         put :update, {:id => user_profile.to_param, :user_profile => invalid_attributes}, valid_session
#         expect(assigns(:user_profile)).to eq(user_profile)
#       end
#
